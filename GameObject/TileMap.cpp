...
//void CTileMap::SetTileJelly(const Vector2& Pos, bool Jelly)
//{
//	int	Index = GetTileIndex(Pos);
//
//	if (Index == -1)
//		return;
//
//	m_vecTile[Index]->SetJelly(Jelly);
//}
//
//void CTileMap::SetTileObstacle(const Vector2& Pos, bool Obstacle)
//{
//	int	Index = GetTileIndex(Pos);
//
//	if (Index == -1)
//		return;
//
//	m_vecTile[Index]->SetObstacle(Obstacle);
//}
