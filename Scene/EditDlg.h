...
private:
	...
	//HWND	m_hJellyCheckBox;
	//HWND	m_hObstacleCheckBox;
...
public:
	...
	//bool GetCheckJelly()	const
	//{
	//	return SendMessage(m_hRenderCheckBox, BM_GETCHECK, 0, 0) == BST_CHECKED;
	//}

	//bool GetCheckObstacle()	const
	//{
	//	return SendMessage(m_hObstacleCheckBox, BM_GETCHECK, 0, 0) == BST_CHECKED;
	//}
