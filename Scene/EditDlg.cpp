...
bool CEditDlg::Init()
{
	...
	//m_hJellyCheckBox = GetDlgItem(m_hDlg, IDC_CHECK_JELLY);
	//m_hObstacleCheckBox = GetDlgItem(m_hDlg, IDC_CHECK_OBSTACLE);
...
void CEditDlg::LoadTexture()
{
	...
	if (GetOpenFileName(&OpenFile) != 0)
	{
		...
		m_Scene->GetSceneResource()->SetColorKey(TextureName, 255, 255, 255);
